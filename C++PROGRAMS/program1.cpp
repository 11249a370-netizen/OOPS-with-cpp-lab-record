...
In main(), create an object of the Student class.
...
RESULT:
The concept of classes and objects in C++ was successfully implemented and executed using a user-defined class with member functions.
